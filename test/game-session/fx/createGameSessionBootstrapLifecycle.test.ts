...
vi.mock("~/game-session/layer/GameSessionLayerFx", async (importOriginal) => {
	const actual = await importOriginal<typeof import("~/game-session/layer/GameSessionLayerFx")>();
...
vi.mock("~/game-session/fx/createGameSessionTransitionSubscriptionsFx", async (importOriginal) => {
	const actual =
		await importOriginal<
			typeof import("~/game-session/fx/createGameSessionTransitionSubscriptionsFx")
		>();
