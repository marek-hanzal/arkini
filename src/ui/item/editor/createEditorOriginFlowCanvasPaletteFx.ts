...
const readPalette = (host: HTMLElement): EditorOriginFlowCanvasPalette => {
...
export const createEditorOriginFlowCanvasPaletteFx = Effect.fn(
	"createEditorOriginFlowCanvasPaletteFx",
)(() =>
	Effect.succeed({
		readPalette,
	}),
