...
- optional line `ahead` opts its owner into one-hop future output-capacity checks when produced; omitted or false leaves that line out of the check. This capability works on Common and Clock lines;
