...
} from "~/renderer/game/resource/GameEngineResourceFx";
import { createGameEngineAcquisitionCapabilityFx } from "~/renderer/game/resource/internal/createGameEngineAcquisitionCapabilityFx";
import { createGameEngineCancellationCapabilityFx } from "~/renderer/game/resource/internal/createGameEngineCancellationCapabilityFx";
import { createGameEngineFinalizationCapabilityFx } from "~/renderer/game/resource/internal/createGameEngineFinalizationCapabilityFx";
import { createFailedSaveRecoveryCapabilityFx } from "~/renderer/game/resource/internal/createFailedSaveRecoveryCapabilityFx";
import type {
	AcquisitionOwner,
