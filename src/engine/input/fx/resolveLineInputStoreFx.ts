 ...
 *
 * Pointer drops omit the line id. Engine-owned commands may name one while preserving the exact
 * same source validation, capacity, and accepted-quantity semantics.
 */
