	...
	return (
		<>
			<Button
				...
				className="h-[var(--ak-control-min-height)] min-h-[var(--ak-control-min-height)] min-w-56 justify-between gap-3 border-control-border bg-[var(--ak-editor-background)] px-4 text-sm shadow-none data-[ui-size=large]:h-12 data-[ui-size=large]:min-h-12"
				title={label}
				{...getReferencePropsFn()}
				{...readDataUiFn({
			...
			{open ? (
				<FloatingPortal>
					<div
						...
						className="z-50 grid gap-1 rounded-xl border border-control-border bg-[var(--ak-editor-background)] p-1.5 shadow-2xl"
