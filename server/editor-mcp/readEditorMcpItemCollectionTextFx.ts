...
import { searchEditorItemsFx } from "../../src/editor/searchEditorItemsFx";
import type { EditorMcpItemCollectionInput } from "./EditorMcpItemCollectionInputSchema";
...
export const readEditorMcpItemCollectionTextFx = Effect.fn("readEditorMcpItemCollectionTextFx")(
	function* (project: EditorProject, input: EditorMcpItemCollectionInput) {
