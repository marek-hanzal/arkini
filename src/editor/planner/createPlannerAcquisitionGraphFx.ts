...
import { readPlannerAcquisitionRoutesFx } from "~/editor/planner/readPlannerAcquisitionRoutesFx";
...
export const createPlannerAcquisitionGraphFx = Effect.fn("createPlannerAcquisitionGraphFx")(
	(config: GameConfigSchema.Type) =>
		Effect.gen(function* () {
			const routes = yield* readPlannerAcquisitionRoutesFx(config);
			...
			const { depthByItemId, reachableRouteIds, routeDepthById, witnessRouteByItemId } =
				yield* resolvePlannerRouteReachabilityFx({
					rootItemIds,
					routes,
				});
