...
- `game/arkini` now contains 247 canonical items, including the two prepared temporary Shrine effect items, Inventory and Memory.
...
All 248 source fragments pass `GameSourceSchema`; the merged 247-item configuration passes `GameSchema`.
