...
export const PeekBottomSheet = forwardRef<HTMLElement, PeekBottomSheetProps>(function PeekBottomSheet(
  {
    open,
    keepMounted = false,
...
export interface PeekBottomSheetProps extends Omit<HTMLAttributes<HTMLElement>, "className" | "children" | "onClose"> {
  open: boolean;
  keepMounted?: boolean;
