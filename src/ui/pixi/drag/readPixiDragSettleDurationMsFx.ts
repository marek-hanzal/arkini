...
export namespace readPixiDragSettleDurationMsFx {
...
export const readPixiDragSettleDurationMsFx = Effect.fn("readPixiDragSettleDurationMsFx")(
	({ fromX, fromY, tileSize, toX, toY }: readPixiDragSettleDurationMsFx.Props) =>
		Effect.sync(() => {
