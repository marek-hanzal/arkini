...
- Editor collection plus menus likewise choose the rule, condition, roll, or outcome type before appending a new entry. Item outcomes offer Local and Random drop placement as separate creation choices; Space outcomes offer exact, Previous Space, and Generated Space. Available rule types follow the owning context; the selected type determines its initial fields and is not switched within the entry detail.
