...
export namespace readGameResourceUsagesFx {
	export type Usage =
		| {
...
export const readGameResourceUsagesFx = Effect.fn("readGameResourceUsagesFx")(
	(config: GameConfigSchema.Type) =>
		Effect.sync(() => {
			const usages: readGameResourceUsagesFx.Usage[] = [];
