...
- gameplay saves use the strict MessagePack envelope `{ version, arkini, state }` and persist atomically under `<userData>/arkini/game/saves/<packageId>/current.arksave`;
