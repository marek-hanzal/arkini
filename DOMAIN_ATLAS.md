...
| `item-schedule` | Periodic Clock-line admission, saved phase/selection and exhausted-owner settlement | [`src/item-schedule/fx/advanceItemSchedulesFx.ts`](src/item-schedule/fx/advanceItemSchedulesFx.ts) |
