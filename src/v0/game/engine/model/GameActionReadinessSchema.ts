import { z } from "zod";
import { GameActionReadyReadinessSchema } from "~/v0/game/engine/model/GameActionReadyReadinessSchema";
import { GameActionRejectedReadinessSchema } from "~/v0/game/engine/model/GameActionRejectedReadinessSchema";
