...
type WeightedOutputEntry = Extract<
	LineOutputEntry,
	{
		type: "weighted";
	}
...
const readWeightedOutputTotalWeight = (entries: WeightedOutputEntry["entries"]) =>
...
const compareOutputViews = (left: EffectiveLootPlanViewEntry, right: EffectiveLootPlanViewEntry) =>
