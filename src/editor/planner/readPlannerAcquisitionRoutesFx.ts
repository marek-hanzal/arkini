...
export const readPlannerAcquisitionRoutesFx = Effect.fn("readPlannerAcquisitionRoutesFx")(
	(config: GameConfigSchema.Type) =>
		Effect.sync((): ReadonlyArray<PlannerAcquisitionRoute> => {
			...
			return [
				...
				...lineDescriptors.flatMap((descriptor) =>
					makeChargeDepletionRoutes(config, descriptor),
				),
