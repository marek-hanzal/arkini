...
| `item-detail` | Item Detail shell, Info, live Lines, Queue and fixed tabs | [`src/item-detail/ui/ItemDetailModal.tsx`](src/item-detail/ui/ItemDetailModal.tsx), [`ItemLines.tsx`](src/item-detail/ui/ItemLines.tsx), [`ItemQueue.tsx`](src/item-detail/ui/ItemQueue.tsx) |
