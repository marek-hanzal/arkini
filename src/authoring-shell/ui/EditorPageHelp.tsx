	...
	return (
		...
		>
			<motion.div
				...
				className="grid max-h-[calc(100dvh-3rem)] w-full max-w-3xl grid-rows-[auto_minmax(0,1fr)] rounded-2xl border border-line-strong bg-modal p-6 text-foreground shadow-2xl"
