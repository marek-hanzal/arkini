...
| Domain | Role | First read |
| --- | --- | --- |
| `space` | Authored destinations, item-owned Inventories (numeric Spaces) and destructive lifetime | [`src/space/fx/resolveInventoryFx.ts`](src/space/fx/resolveInventoryFx.ts) |
...
| `audio-authoring` | Editor-only Music/SFX names and details, library import, lazy preview and canonical Ogg/Opus preparation | [`src/audio-authoring/ui/EditorAudioResourceManager.tsx`](src/audio-authoring/ui/EditorAudioResourceManager.tsx) |
...
| `window-mode` | Saved window-mode preference and native synchronization | [`src/window-mode/fx/bootstrapWindowModeSyncFx.ts`](src/window-mode/fx/bootstrapWindowModeSyncFx.ts) |
