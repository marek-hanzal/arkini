...
import type { ItemChargesIssueSchema } from "~/game-runtime/schema/check/ItemChargesIssueSchema";
import type { ItemMaxCountIssueSchema } from "~/game-runtime/schema/check/ItemMaxCountIssueSchema";
import type { ItemStackSizeIssueSchema } from "~/game-runtime/schema/check/ItemStackSizeIssueSchema";
...
import type { ItemTemporaryDurationIssueSchema } from "~/game-runtime/schema/check/ItemTemporaryDurationIssueSchema";
import type { LocationOccupiedIssueSchema } from "~/game-runtime/schema/check/LocationOccupiedIssueSchema";
import type { LocationOutOfBoundsIssueSchema } from "~/game-runtime/schema/check/LocationOutOfBoundsIssueSchema";
import type { LocationScopeIssueSchema } from "~/game-runtime/schema/check/LocationScopeIssueSchema";
