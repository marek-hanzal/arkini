...
export const EditorFormSectionPage = ({
	...
	>
		<div
			className="mx-auto grid w-full min-w-0 gap-3 min-[96rem]:w-3/4 data-[ui-content-mode=viewport]:flex data-[ui-content-mode=viewport]:h-full data-[ui-content-mode=viewport]:min-h-0 data-[ui-content-mode=viewport]:flex-col data-[ui-content-mode=viewport]:overflow-y-auto data-[ui-content-mode=viewport]:p-3"
			{...readDataUiFn({
