...
- `stageCommandVisualEvents`, the Arkini adapter that maps command visual events into generic actor motion entries before the next query invalidation renders final tiles.
