...
export function resolveGameDrop(
  ...
  switch (route) {
    case "inventory->inventory-slot":
      return inventoryToInventory(context as GameDropContext<"inventory", "inventory-slot">, game, actions);
    case "board->cell":
...
export function getGameDragBoundaryNodeId(source: DraggablePayload<string, GameDragSource, GameVisualMeta>) {
