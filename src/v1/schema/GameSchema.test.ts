	...
	it("parses the current Arkini game configuration after source fragments are merged", () => {
		expect(
			GameSchema.safeParse({
				...ArkiniGameConfig,
				items: {
					...LumberjackBlueprintSource.items,
					...QuarryBlueprintSource.items,
					...SawmillBlueprintSource.items,
					...ShrineBlueprintSource.items,
					...StonemasonBlueprintSource.items,
					...WellBlueprintSource.items,
					...BioWasteSource.items,
					...EggSource.items,
					...FeastPlateSource.items,
					...GrainSource.items,
					...MilkSource.items,
					...MoraleSource.items,
					...PigletSource.items,
					...FarmersFavorSource.items,
					...VegetablesSource.items,
					...WoolSource.items,
					...BeerBarrelSource.items,
					...BeerSource.items,
					...BreadSource.items,
					...CheeseSource.items,
					...CoinSource.items,
					...
					...GrapesSource.items,
					...HopsSource.items,
					...MoraleT2Source.items,
					...TavernCommissionSource.items,
					...SausageSource.items,
					...WineBarrelSource.items,
					...WineGlassSource.items,
					...BasicKnowledgeSource.items,
					...BuildingPermitSource.items,
					...PaperSource.items,
					...CommonClothSource.items,
					...CommonClothingSource.items,
					...LeatherSource.items,
					...LuxuryClothSource.items,
					...LuxuryClothingSource.items,
					...MoraleT3Source.items,
					...PigmentSource.items,
					...RawHideSource.items,
					...LogSource.items,
					...StoneSource.items,
