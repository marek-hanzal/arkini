...
**Next implementation task: [`08-multi-space-board-runtime.md`](08-multi-space-board-runtime.md)**

Tasks 00–07 are complete. A new thread must:
...
| 08 | [`Multi-space board runtime`](08-multi-space-board-runtime.md) | **Ready** | 07 |
