...
type SpaceTransitionPresentationPhase =
	| {
...
/** Keeps the source space visible while earlier facts from one atomic space change are projected. */
export const readSpaceTransitionPresentationPhasesFn = (
	transition: GameTransition,
): readonly SpaceTransitionPresentationPhase[] => {
