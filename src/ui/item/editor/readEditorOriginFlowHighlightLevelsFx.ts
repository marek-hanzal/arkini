...
import type { EditorOriginFlowHighlight } from "~/ui/item/editor/EditorOriginFlowHighlight";

/** Assigns breadth-first visual depth to every node and edge in one selected flow. */
export const readEditorOriginFlowHighlightLevelsFx = Effect.fn(
	"readEditorOriginFlowHighlightLevelsFx",
)((flow: EditorItemOriginFlow, highlight: EditorOriginFlowHighlight, rootNodeId: string) =>
