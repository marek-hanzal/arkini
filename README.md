...
| Text relationship discovery | `graph_search`, `graph_connections`, `graph_operations`, `graph_path`, `graph_flow`, `graph_traverse`, `graph_batch` |
