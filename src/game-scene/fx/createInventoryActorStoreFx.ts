...
import type { InventoryDropTarget, InventorySurface } from "~/game-scene/service/InventorySurface";

interface CreateInventoryActorStoreProps {
...
export const createInventoryActorStoreFx = Effect.fn("createInventoryActorStoreFx")(
	({
		...
		surface,
		textures,
	}: CreateInventoryActorStoreProps) =>
