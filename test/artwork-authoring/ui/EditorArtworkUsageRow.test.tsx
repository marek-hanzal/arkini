...
const renderUsage = async (usage: readGameResourceUsagesFn.Usage) => {
	...
	if (link === null) throw new Error("Expected a routed artwork usage.");
	return link;
};

describe("EditorArtworkUsageRow", () => {
	it("opens project hero and avatar usages in their exact Images destination", async () => {
