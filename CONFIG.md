...
- each start entry creates one item in its exact Board cell; runtime items represent single identities, while authored input and Item outcome quantities count separate items;
