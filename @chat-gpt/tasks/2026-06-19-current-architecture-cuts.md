...
1. Continue `game/engine/fx` production reshaping domain-by-domain. Next safest coding tasks: jobs/item-spawn helpers, board/inventory action helpers, merge/remove, loot/ID utility clusters. No behavior changes.
