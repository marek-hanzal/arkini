...
export namespace runEditorProjectMutationFx {
	...
	export interface Props {
		...
		) => Effect.Effect<Result, unknown, AtomRegistry.AtomRegistry>;
	}
}
 ...
 */
export const runEditorProjectMutationFx = Effect.fn("runEditorProjectMutationFx")(
	function* ({ expectedRevision, projectId, run }: runEditorProjectMutationFx.Props) {
