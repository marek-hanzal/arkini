...
interface OutputOccurrence {
	...
	readonly occurrenceQuantityDistribution: ReadonlyArray<AcquisitionQuantityProbability>;
...
export const readAcquisitionOutputOccurrencesFn = (
	...
	const groupMarginals = new Map<string, ReadonlyArray<AcquisitionQuantityProbability>>();
	...
	const occurrenceMarginals = new Map<string, ReadonlyArray<AcquisitionQuantityProbability>>();
