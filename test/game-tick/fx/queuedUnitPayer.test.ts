...
import { board } from "~test/production-action/fx/itemUnits.test/fixture";
import { createConfig } from "./queuedUnitPayer.test/fixture";
...
it("keeps a queued final-unit payer intact without freezing the session, then retries after queue clearing", async () => {
