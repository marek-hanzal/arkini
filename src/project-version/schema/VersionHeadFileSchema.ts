...
export const VersionHeadFileSchema = z
	.object({
		current: IdSchema,
...
export type VersionHeadFileSchema = typeof VersionHeadFileSchema;

export namespace VersionHeadFileSchema {
	export type Type = z.infer<VersionHeadFileSchema>;
}
