...
const chatGptAssetAuthoringAllowedSourceDependencyPattern =
	"(?:chatgpt-asset-authoring(?:/|$)|application-runtime/service/RendererRuntime[.]ts$|asset-authoring/(?:fn/readEditorAssetResourceIdFn|session/saveEditorAssetFx|validation/validateEditorAssetFileFx)[.]ts$|authoring-session/ui/(?:useEditorProject|useEditorUnsavedChangesRegistration)[.]ts$|project-authoring/service/EditorProjectRepository[.]ts$|ui/(?:button/Button[.]tsx$|form/EditorInputClassName[.]ts$|reactivity/readSettledAsyncResultErrorFx[.]ts$))";
...
const productDomainPattern = `^src/(?:asset-authoring/fn|editor-build/(?:fn|schema|service)|estimate/(?:fn|schema|type))(?:/|$)|${flowPattern}`;
