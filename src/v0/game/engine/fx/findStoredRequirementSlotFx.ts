...
export namespace findStoredRequirementSlotFx {
	export interface Props {
		itemId: string;
		storedRequirements: readonly Extract<
			GameRequirement,
			{
				type: "stored";
			}
...
export const findStoredRequirementSlotFx = Effect.fn("findStoredRequirementSlotFx")(function* ({
	itemId,
	storedRequirements,
}: findStoredRequirementSlotFx.Props) {
