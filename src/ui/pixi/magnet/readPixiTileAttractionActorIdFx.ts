...
export namespace readPixiTileAttractionActorIdFx {
...
export const readPixiTileAttractionActorIdFx = Effect.fn("readPixiTileAttractionActorIdFx")(
	({ previewKind, targetItem }: readPixiTileAttractionActorIdFx.Props) =>
		Effect.sync(() => {
