...
vi.mock("~/project-authoring/configuration/EditorProjectStartGrid", () => ({
...
import { boardSpaceProject } from "~test/project-authoring/EditorProjectSectionSession.test/BoardSpaceProject";
