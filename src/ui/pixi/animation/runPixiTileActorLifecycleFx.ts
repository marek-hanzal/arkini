...
export namespace runPixiTileActorLifecycleFx {
	export type Action =
		| (LifecycleProps & {
...
export const runPixiTileActorLifecycleFx = Effect.fn("runPixiTileActorLifecycleFx")(function* (
	action: runPixiTileActorLifecycleFx.Action,
) {
