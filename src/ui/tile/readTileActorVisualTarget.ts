	...
	match({
		...
		.with(
			...
			() => ({
				scale: 0.75,
				opacity: 1,
				filter: "brightness(1.08) drop-shadow(0 0.7rem 1rem color-mix(in srgb, var(--ak-accent) 30%, transparent))",
			}),
		)
		.with(
			{
			...
			() => ({
				scale: 0.84,
				opacity: 0.76,
				filter: "brightness(0.98) drop-shadow(0 0.7rem 1rem color-mix(in srgb, var(--ak-overlay) 42%, transparent))",
			}),
		)
		.with(
			{
			...
			() => ({
				scale: 0.8,
				opacity: 0.6,
				filter: "brightness(0.94) drop-shadow(0 0.55rem 0.8rem color-mix(in srgb, var(--ak-danger) 28%, transparent))",
			}),
		)
		.with(
			{
		...
		.with(
			...
			() => ({
				scale: 0.75,
				opacity: 1,
				filter: "brightness(1.08) drop-shadow(0 0.65rem 0.9rem color-mix(in srgb, var(--ak-accent) 30%, transparent))",
			}),
		)
		.with(
			{
			...
			() => ({
				scale: 0.78,
				opacity: 1,
				filter: "brightness(0.96) drop-shadow(0 0.55rem 0.75rem color-mix(in srgb, var(--ak-danger) 28%, transparent))",
			}),
		)
		.with(
			{
		...
		.with(
			...
			() => ({
				scale: 0.84,
				opacity: 1,
				filter: "brightness(1.05) drop-shadow(0 0.65rem 0.85rem color-mix(in srgb, var(--ak-danger) 36%, transparent))",
			}),
		)
		.with(
			{
