...
describe("readEffectiveProducerLine", () => {
	...
	it("hides hidden producer lines until their visibility grant is present", () => {
	...
	it("evaluates nearby requirements and exact distance bands from the producer line", () => {
		const baseConfig = createEngineTestConfig();
		const config = createEngineTestConfig({
			game: {
				...baseConfig.game,
