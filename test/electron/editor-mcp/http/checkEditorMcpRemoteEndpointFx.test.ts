...
import { checkEditorMcpRemoteEndpointFx } from "../../../../electron/main/editor-mcp/http/checkEditorMcpRemoteEndpointFx";
...
describe("checkEditorMcpRemoteEndpointFx", () => {
	it.effect("times out one attempt before retrying a healthy endpoint", () =>
		Effect.gen(function* () {
			...
			const check = yield* checkEditorMcpRemoteEndpointFx(
				new URL("https://editor.example"),
