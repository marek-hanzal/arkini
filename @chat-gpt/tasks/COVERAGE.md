...
Historical audio was explicitly rejected and `src/_archive/audio/**` removed. [#259](https://github.com/marek-hanzal/arkini/issues/259) owns a new design from first principles and does not block parity pruning.
