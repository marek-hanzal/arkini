...
- 2026-06-18: Flat UI follow-up removed the remaining app-level custom visual CSS classes, shadows and gradients, tightened sheet header padding, aligned badges to `bottom-0 right-0`, removed inventory double-border styling and fixed TileEngine actor/grid gap alignment. See `@chat-gpt/v0/v0-flat-ui-bottom-sheet-grid-polish-2026-06-18.md`.
