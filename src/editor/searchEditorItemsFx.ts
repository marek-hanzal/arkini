...
export const searchEditorItemsFx = Effect.fn("searchEditorItemsFx")(
	(items: ReadonlyArray<ItemSchema.Type>, query: string) =>
		Effect.sync((): ReadonlyArray<ItemSchema.Type> => {
