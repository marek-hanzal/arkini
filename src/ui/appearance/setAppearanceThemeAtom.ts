...
import { writeAppearanceThemeFx } from "~/ui/appearance/writeAppearanceThemeFx";
...
const rollbackAppearanceThemeFx = Effect.fn("rollbackAppearanceThemeFx")(
	({
		...
		readonly optimisticTheme: AppearanceThemeSchema.Type;
		readonly previousTheme: AppearanceThemeSchema.Type;
	}) =>
		Effect.gen(function* () {
...
export const setAppearanceThemeAtom = Atom.fn(
	(nextTheme: AppearanceThemeSchema.Type) =>
		Effect.gen(function* () {
