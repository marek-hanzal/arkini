...
export const SegmentedControl = <Value extends string>({
	...
	<div
		className={`ak-segmented-control ${fill ? "flex w-full" : "inline-flex w-fit max-w-full self-start"} ${SegmentedControlFrameSizeClassName[size]} min-w-0 overflow-x-auto rounded-lg bg-canvas/70`}
		{...readDataUiFn({
			dataUi,
			state: {
				fill,
