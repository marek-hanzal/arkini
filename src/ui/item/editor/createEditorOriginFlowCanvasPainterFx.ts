...
export interface EditorOriginFlowCanvasPalette {
...
const readCanvasPalette = (host: HTMLElement): EditorOriginFlowCanvasPalette => {
...
/** Creates the token-aware Canvas painter for editor origin-flow nodes and routes. */
