...
- Heroes Guild I is the current post-goldsmith test branch: Goldsmith sells its blueprint for coins, guild expeditions consume coins plus food/drink, return tiered locked hero chests, and chests open as keyed stashes. Hero keys are cheat-only placeholders for now.
