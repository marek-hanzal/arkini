...
export async function syncGameConfig(config: GameConfig = GameConfig): Promise<GameConfigSyncResult> {
  ...
  return db.transaction().execute(async (tx) => {
    ...
    await tx
      ...
      .values({ key: "gameConfigHash", value: hash, updatedAt: timestamp })
