...
export function TileContent({ item, quantity, producer }: TileContent.Props) {
	...
	return (
		...
		>
			...
			{item.label ? (
				<span className="absolute bottom-0.5 right-0.5 min-w-4 rounded-sm bg-slate-950/85 px-1 text-center text-[0.62rem] font-black text-amber-200">
					{item.label}
				</span>
			) : null}
