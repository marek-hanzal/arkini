...
interface CheatItemSpotlightSearchItem {
...
interface CheatItemSpotlightSearchProps {
	readonly game: PlayableGame;
}

interface CheatItemSpotlightSearchOutput {
	readonly changeQuery: (query: string) => void;
	readonly query: string;
	readonly reset: () => void;
	readonly results: ReadonlyArray<CheatItemSpotlightSearchItem>;
...
export const useCheatItemSpotlightSearch = ({
	game,
}: CheatItemSpotlightSearchProps): CheatItemSpotlightSearchOutput => {
