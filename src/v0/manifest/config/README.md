...
Keep definition files boring and grouped by gameplay family:

- natural/material chains in `NaturalItemDefinitions.ts`
- currencies in `CurrencyItemDefinitions.ts`
- crates and keys in `CrateItemDefinitions.ts`
- building items in `BuildingItemDefinitions.ts`
- blueprint chains in `BlueprintItemDefinitions.ts`
