...
export namespace createPixiSpaceActionTransitionPresenterFx {
...
export const createPixiSpaceActionTransitionPresenterFx = Effect.fn(
	...
	}: createPixiSpaceActionTransitionPresenterFx.Props) =>
		Effect.sync(() => {
			let closed = false;
			...
			const queuedTransitions: Array<{
				readonly delivery: createPixiSpaceActionTransitionPresenterFx.Delivery;
			...
			const applyAdmitted = (
				...
				delivery: createPixiSpaceActionTransitionPresenterFx.Delivery,
			) => {
				if (closed) return;
