...
export namespace readTileActorQueueBadgeCountFx {
...
export const readTileActorQueueBadgeCountFx = Effect.fnUntraced(function* ({
	ownerItemId,
	runtime,
}: readTileActorQueueBadgeCountFx.Props) {
	const count =
