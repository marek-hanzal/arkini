	...
	return (
		...
		>
			<motion.div
				...
				className="relative flex h-[90%] max-h-full w-[90%] max-w-full cursor-default flex-col overflow-hidden rounded-2xl border border-line/50 bg-modal p-[var(--ak-panel-padding)] text-foreground shadow-[0_2rem_5rem_color-mix(in_srgb,var(--ak-overlay)_58%,transparent)]"
