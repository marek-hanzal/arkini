...
const compileEditorAcquisitionLineRoutesFn = (config: GameConfigSchema.Type) => {
	const routes: EditorAcquisitionRoute[] = [];
...
const compileEditorAcquisitionMergeRoutesFn = (config: GameConfigSchema.Type) => {
	const routes: EditorAcquisitionRoute[] = [];
	for (const item of Object.values(config.items)) {
...
const compileEditorAcquisitionTemporaryRoutesFn = (config: GameConfigSchema.Type) => {
	const routes: EditorAcquisitionRoute[] = [];
	for (const item of Object.values(config.items)) {
