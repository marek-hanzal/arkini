...
/**
 * An alternative non-empty collection of outcome rolls.
 *
 * An outcome filters available sets by their rules, selects one by relative weight,
 * then evaluates every roll in that set. No available set means no outcome.
 */
export const RollSetSchema = z
	...
	.meta({
		id: "roll.SetSchema",
		description: "An alternative non-empty collection of outcome rolls.",
	});
