...
export const BoardCellCooldownProgress: FC<BoardCellCooldownProgress.Props> = memo(
	({ progress }) => {
		...
		return (
			<div className="pointer-events-none absolute inset-x-0 bottom-0 h-1 overflow-hidden bg-violet-50/85">
				<div
					className="h-full origin-left bg-violet-400/85 transition-transform duration-200 ease-linear"
					style={{
