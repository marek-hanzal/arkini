...
import { DetailCard, DetailMutedPill, DetailSeparator } from "~/v0/item-detail/ui/DetailCard";
import { effectDetailPolarityTabs } from "~/v0/item-detail/ui/effectDetailPresentation";
