...
export namespace readRuntimeLootDropViewsFromEffectiveProducerLine {
...
export const readRuntimeLootDropViewsFromEffectiveProducerLine = ({
	effectiveProducerLine,
}: readRuntimeLootDropViewsFromEffectiveProducerLine.Props): ActivationDropView[] => {
