...
/** Creates a synchronous live-actor contact reader for animation-frame target projection. */
export const makePixiLiveActorContactPoseReaderFx = Effect.fnUntraced(function* () {
	return ({
		actorId,
		actors,
		movingActor,
